...
/**
 * Performs lightweight permutation and substitution on the given sequence.
 *
 * @param seq           The input sequence to be modified.
 * @param mask          The mask used for substitution.
 * @param prev_count    The initial count of characters to be substituted.
 * @param count         The target count of characters to be substituted.
 */
